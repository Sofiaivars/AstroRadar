...
function SignUpForm({handleClick}){
  ...
  const handleInputChange = (event) => {
    ...
    if(id === "signup-image"){ return setUserImage(value)}
  }
  ...
  return(
    <div className="flex flex-col bg-gray-800 p-4 rounded-2xl gap-3">
      ...
      <input type="text" name="userimage" className="bg-gray-400 p-2 rounded-2xl" id="signup-image" placeholder="Imagen" value={userImage} onChange={handleInputChange}/>

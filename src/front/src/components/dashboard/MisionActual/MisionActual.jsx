...
const MisionActual = () => {
  ...
  return (
    <div className="rounded-[12px] p-[2px] bg-gradient-to-r from-purple-500 via-fuchsia-500 to-cyan-500">
      <div
        className="relative w-[400px] h-[330px] rounded-[12px] overflow-hidden shadow-lg text-white font-poppins"
        style={{
        ...
        <div className="relative z-10 flex flex-col justify-between h-full p-6">
          <div className="flex flex-col">
            <div className="self-start">
              <span className="text-sm font-normal">{missionStatus}</span>
            </div>

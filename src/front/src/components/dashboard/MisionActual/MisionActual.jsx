...
const MisionActual = () => {
  ...
  const missionName = activeMission?.event?.name || "Activa una misión";
  const missionStatus = activeMission?.state || "Sin misión activa";
  const location = activeMission?.base?.base_name || "Sin ubicación asignada";

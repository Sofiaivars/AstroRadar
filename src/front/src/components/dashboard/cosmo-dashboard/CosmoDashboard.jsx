...
function CosmoDashboard(){
  ...
  return(
    <div className='flex flex-col justify-center items-start h-70 w-70 relative overflow-hidden'>
      <div className='flex items-center justify-center bg-sky-950 rounded-t-2xl rounded-s-2xl w-8/9 p-3 h-20 max-h-20 ms-1 relative cosmoMessage'>
        {cosmoTip ? <p className='text-xs text-center'>{cosmoTip}</p> : <div class="cosmoTipLoader"><div class="cosmoTipLoader1"></div></div>}

...
const updateMissionState = async (missionId, missionState) => {
  const response = await fetch(
    `${mainURL}/umissions/update_mission_state/${missionId}`,
    {
      method: "PUT",
      headers: { "Content-Type": "application/json" },
...
const deleteMission = async (missionId) => {
  const response = await fetch(
    `${mainURL}/umissions/delete-mission/${missionId}`,
    {
      method: "DELETE",
    }
  );
...
const updateStellarBase = async (baseId, missionId) => {
  const response = await fetch(
    `${mainURL}/umissions/update-base/${missionId}`,
    {
      method: "PUT",
      headers: { "Content-Type": "application/json" },
...
const updateMissionImage = async (missionID, imageSrc) => {
  const response = await fetch(
    `${mainURL}/umissions/update-mission-image/${missionID}`,
    {
      method: "PUT",
      headers: { "Content-Type": "application/json" },
